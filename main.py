...
def main():
    ...
    parser.add_argument('--pipeline_yaml', default='./playbooks/playbook.yaml', help='Path to workflow yaml file to pipeline (optional)')
    parser.add_argument('--pipeline_output_dir', default='command_outputs/jenkinsFiles/Jenkinsfile', help='Path to pipeline output directory (optional)')
